          ...
          <form className="mt-8" onSubmit={handleSubmit(submitForm)}>
            ...
            <div className="flex justify-between mb-8">
              ...
              <div>
                ...
                <Input {...register("goal", { required: true })} id="goal" placeholder="Amout to raise in ether" name="goal" className="mt-2 rounded-lg placeholder:text-xs" error={errors && errors.goal?.message} />
                <ErrorText message={errors && errors.goal?.message} />

                <Label htmlFor='duration' className='text-sm'>Duration</Label>
                <Input {...register("duration", { required: true })} id="duration" placeholder="Duration in days" name="duration" className="mt-2 rounded-lg placeholder:text-xs" error={errors && errors.duration?.message} />
